...
<div class="max-w-xl mx-auto px-6 py-8">
    ...
    <div class="bg-white dark:bg-[#18181c] p-6 my-20 rounded-sm shadow-sm border border-gray-200 dark:border-white/10 transition-colors">
        ...
        <form action="/products" method="POST">
            ...
            <div class="mb-5">
                ...
                <select name="category_id"
                    required
                    id="category_id"
                    class="w-full border border-gray-300 dark:border-white/10 bg-white dark:bg-[#1f1f23] text-black dark:text-white px-3 py-2 rounded-md
           focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition">
                    ...
                    <option value="{{ $category->id }}" class="text-white">
                        {{ $category->name }}
                    </option>
                    @endforeach
                    @endif
